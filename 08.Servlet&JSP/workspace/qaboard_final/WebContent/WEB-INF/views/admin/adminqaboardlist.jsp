...
<script>
	$(document).ready(function() {
		...
		$("button.btnPrevious").on("click", function() {
		 	location.assign("${pageContext.request.contextPath}/admin/qaboardlist?pageNum=${previous}#bottom");
		});
		$("button.btnNext").on("click", function() {
		  	location.assign("${pageContext.request.contextPath}/admin/qaboardlist?pageNum=${next}#bottom");
		});
