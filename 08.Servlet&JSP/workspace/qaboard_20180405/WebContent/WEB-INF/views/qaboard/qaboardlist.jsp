					...
					<table class="table">
						...
						<tbody>
							...
							<c:forEach var="q" items="${list}" varStatus="a">
								<tr>
									<td>${q.qid}</td>
									<td><a href="#demo${a.index}" data-toggle="collapse">${q.title}</a>
									...
									<td>${q.writeday}</td>
									<td><button type="button"
											class="btn btn-default btn-xs btnReply" title="관리자 답변" disabled="disabled">답변보기</button></td>
								</tr>
							</c:forEach>
				...
				<div class="modal-body">
					...
					<form role="form"
						...
						<div class="form-group" id="pwForm" style="display: none;">
							<input type="password" class="form-control " id="insertformpw"
								name="pw" placeholder="패스워드 (4자리)" maxlength="4"
					...
					<form role="form" method="post"
						...
						<div class="form-group">
							<label for="pw"> Password :</label> <input type="password"
								class="form-control" id="loginformpw" name="pw"
