...
public class EmployeeService {
	...
	// 직원관리v3.0 MySQL > 1.직원관리
	public void menu_1(Scanner sc) {
		// 메뉴 액션
		boolean run = true;
		while (run) {
			System.out.println("-------------------------------");
			System.out.println("직원관리v3.0 MySQL > 1.직원관리");
			System.out.println("-------------------------------");
	...
	private void menu_11(Scanner sc) {
		...
		List<Employee> departmentList = this.employeeJDBCTemplate.departmentList();
		System.out.println("----------------");
		...
		if (basicpay.equals("0"))
			return;
		System.out.print("수당:");
		String extrapay = sc.nextLine();
		if (extrapay.equals("0"))
			return;
		...
		int result = this.employeeJDBCTemplate.add(emp);

		System.out.println("1개의 행이 추가되었습니다.");

	}

	// 직원관리v3.0 MySQL > 1.직원관리 > 2.직원전체출력
	private void menu_12(Scanner sc) {
		// 메뉴 액션
		boolean run = true;
		while (run) {
			System.out.println("-------------------------------------------------");
			System.out.println("직원관리v3.0 MySQL > 1.직원관리 > 2.직원전체출력");
			System.out.println("-------------------------------------------------");
	...
	private void employeesList(String key) {
		...
		for (Employee e : list) {
			System.out.printf("%s/ %s/ %s/ %s/ %s/ %s/ %s/ %s/ %s/ %s%n", e.getEid(), e.getName_(), e.getHiredate(),
					e.getPhone(), e.getReg_name(), e.getDept_name(), e.getJob_title(), e.getBasicpay(), e.getExtrapay(),
					e.getPay());
		}
	}

	// 직원관리v3.0 MySQL > 1.직원관리 > 3.직원검색
	private void menu_13(Scanner sc) {
		// 메뉴 액션
		boolean run = true;
		while (run) {
			System.out.println("--------------------------------------------");
			System.out.println("직원관리v3.0 MySQL > 1.직원관리 > 3.직원검색");
			System.out.println("--------------------------------------------");
	...
	// 직원관리v3.0 MySQL > 1.직원관리 > 3.직원검색 > 1.사번기준
	...
	// 직원관리v3.0 MySQL > 1.직원관리 > 3.직원검색 > 2.이름기준
	...
	// 직원관리v3.0 MySQL > 1.직원관리 > 3.직원검색 > 3.지역기준
	...
	// 직원관리v3.0 MySQL > 1.직원관리 > 3.직원검색 > 4.부서기준
	...
	// 직원관리v3.0 MySQL > 1.직원관리 > 3.직원검색 > 5.직위기준
	...
	private int employeesSearch(String key, String value) {
		...
		if (result > 0) {
			...
			for (Employee e : list) {
				System.out.printf("%s/ %s/ %s/ %s/ %s/ %s/ %s/ %s/ %s/ %s%n", e.getEid(), e.getName_(), e.getHiredate(),
						e.getPhone(), e.getReg_name(), e.getDept_name(), e.getJob_title(), e.getBasicpay(),
	...
	private void menu_14(Scanner sc) {
		...
		if (result > 0) {
			...
			int count = this.employeeJDBCTemplate.remove(eid);
			System.out.printf("%d개의 행이 삭제되었습니다.%n", count);
		}

	}

	// 직원관리v3.0 MySQL > 2.기초정보관리
	public void menu_2(Scanner sc) {
		// 메뉴 액션
		boolean run = true;
		while (run) {
			System.out.println("-----------------------------------");
			System.out.println("직원관리v3.0 MySQL > 2.기초정보관리");
			System.out.println("-----------------------------------");
	...
	// 직원관리v3.0 MySQL > 2.기초정보관리 > 1.지역관리
	private void menu_21(Scanner sc) {
		// 메뉴 액션
		boolean run = true;
		while (run) {
			System.out.println("------------------------------------------------");
			System.out.println("직원관리v3.0 MySQL > 2.기초정보관리 > 1.지역관리");
			System.out.println("------------------------------------------------");
	...
	// 직원관리v3.0 MySQL > 2.기초정보관리 > 1.지역관리 > 1.지역입력
	private void menu_211(Scanner sc) {
		...
		int result = this.employeeJDBCTemplate.regionInsert(reg_name);
		System.out.printf("%d개의 행이 추가되었습니다.%n", result);

	}

	// 직원관리v3.0 MySQL > 2.기초정보관리 > 1.지역관리 > 2.지역출력
	...
	// 직원관리v3.0 MySQL > 2.기초정보관리 > 1.지역관리 > 3.지역삭제
	...
	// 직원관리v3.0 MySQL > 2.기초정보관리 > 2.부서관리
	private void menu_22(Scanner sc) {
		// 메뉴 액션
		boolean run = true;
		while (run) {
			System.out.println("------------------------------------------------");
			System.out.println("직원관리v3.0 MySQL > 2.기초정보관리 > 2.부서관리");
			System.out.println("------------------------------------------------");
	...
	// 직원관리v3.0 MySQL > 2.기초정보관리 > 2.부서관리 > 1.부서입력
	private void menu_221(Scanner sc) {
		System.out.println("부서번호/ 부서이름");
		for (Employee e : this.employeeJDBCTemplate.departmentList()) {
			System.out.printf("%s/ %s%n", e.getDept_id(), e.getDept_name());
		}
		System.out.print("신규 등록 부서이름:");
		String dept_name = sc.nextLine();

		int result = this.employeeJDBCTemplate.departmentInsert(dept_name);
		System.out.printf("%d개의 행이 추가되었습니다.%n", result);

	}

	// 직원관리v3.0 MySQL > 2.기초정보관리 > 2.부서관리 > 2.부서출력
	...
	// 직원관리v3.0 MySQL > 2.기초정보관리 > 2.부서관리 > 3.부서삭제
	private void menu_223(Scanner sc) {
		...
		System.out.print("삭제할 지역의 부서번호:");
		String dept_id = sc.nextLine();

		int result = this.employeeJDBCTemplate.departmentDelete(dept_id);
		System.out.printf("%d개의 행이 삭제되었습니다.%n", result);

	}
	
	
	// 직원관리v3.0 MySQL > 2.기초정보관리 > 3.직위관리
	private void menu_23(Scanner sc) {
		// 메뉴 액션
		boolean run = true;
		while (run) {
			System.out.println("------------------------------------------------");
			System.out.println("직원관리v3.0 MySQL > 2.기초정보관리 > 3.직위관리");
			System.out.println("------------------------------------------------");
	...
	// 직원관리v3.0 MySQL > 2.기초정보관리 > 3.직위관리 > 1.직위입력
	private void menu_231(Scanner sc) {
		...
		int result = this.employeeJDBCTemplate.jobInsert(job_title);
		System.out.printf("%d개의 행이 추가되었습니다.%n", result);

	}

	// 직원관리v3.0 MySQL > 2.기초정보관리 > 3.직위관리 > 2.직위출력
	...
	// 직원관리v3.0 MySQL > 2.기초정보관리 > 3.직위관리 > 3.직위삭제
