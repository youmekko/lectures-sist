...
public class Member {
	...
	//회원번호, 이름, 전화번호, 이메일, 등록일, 부서번호, 부서명, 회비납부일, 회비금액, 회비총액
	//mid, name_, phone, email, regDate, deptId, deptName, feeDate, fee, feeTotal
	
	//필드 구성
	private String mid, name_, phone, email, deptId, deptName;
	private LocalDate regDate, feeDate;
	private int fee, feeTotal;
	...
	//회원 정보 + 회비납부총액 출력시 사용할 전용 생성자
	public Member(String mid, String name_, String phone, String email,
			LocalDate regDate, String deptName, int feeTotal) {
		this.mid = mid;
		this.name_ = name_;
		this.phone = phone;
		this.email = email;
	...
	//특정 회원의 회비 납부 액션용 전용 생성자
	public Member(String mid, LocalDate feeDate, int fee) {
		this.mid = mid;
	...
	//특정 회원의 회비 출력 전용 생성자
	public Member(LocalDate feeDate, int fee) {
		this.feeDate = feeDate;
		this.fee = fee;
	}
	...
	public String toString() {
		return String.format("%s %s %s %s %s %s %s", mid, name_, phone, email, regDate, deptName, feeTotal);
	}
